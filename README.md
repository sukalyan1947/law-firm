...
<head>
    ...
    <title>Legal Force Law Firm</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            margin: 0;
            background-color: #C19A6B; /* fallback color */
        }

        add buttons. and make it better. the buttons should work. /* Banner / Header */ 
        header {
            text-align: center;
            color: #fff;
            padding: 80px 20px;
            background: linear-gradient(270deg, #5C2A00, #2B1A0F, #5C2A00); /* deep chestnut to blackish */
            background-size: 600% 600%; /* needed for animation */
            animation: gradientShift 10s ease infinite; /* smooth infinite animation */
        }
...
<!-- Header -->
<header style="position: relative; text-align: center; padding: 100px 20px; 
    background: linear-gradient(135deg, #2B1A0F, #5C2A00, #3b2f2f); 
    color: #fff; background-size: 300% 300%; 
    animation: gradientShift 10s ease infinite; overflow: hidden;">

    <h1 style="font-size: 3.2em; margin-bottom: 15px; letter-spacing: 1px; text-transform: uppercase;
...
header a:hover {
  ...
  <!-- Motto Section - Regal Glow Style -->
<section id="motto">
...
<script>
const serviceInfo = {
  1: {title: "Divorce & Family Disputes", details: "Divorce and family matters are never easy. They strike at the core of human emotions while also carrying heavy legal implications. At our firm, we blend compassion with strategy. We listen deeply, because behind every case is a real story — families, children, finances, and futures at stake. Our role is not just to fight legal battles but to help clients transition into a stable future with dignity. Whether it’s child custody, alimony, property division, or guardianship issues, we advocate fiercely while keeping your emotional well-being in mind. Unlike cookie-cutter legal solutions, we tailor strategies for long-term peace, not short-term wins. With empathy as our compass and precision as our weapon, we ensure that sensitive family disputes are resolved with minimal hostility and maximum fairness. Our goal is to protect what matters most — your family, your rights, and your peace of mind."},
  2: {title: "Eviction & Property Disputes", details: "Property conflicts are more than just legal issues; they often involve life savings, generational assets, and emotional investments. Whether you are a property owner fighting for rightful possession or a tenant safeguarding your residence, our team brings a sharp, balanced approach. We handle unlawful detainers, tenancy disagreements, landlord harassment cases, and illegal eviction attempts with clarity and speed. With in-depth knowledge of property law and local regulations, we defend ownership rights while respecting tenancy protections. Every case is pursued with meticulous documentation, strategic negotiation, and strong courtroom advocacy when necessary. We don’t just resolve disputes; we prevent them from dragging into endless legal battles that drain time and resources. By blending aggressive representation with pragmatic settlements, we ensure your property interests remain secure. With us, your home and investments stay protected under the strongest legal shield."},
  3: {title: "Probate & Succession", details: "The passing of a loved one is emotionally overwhelming. Adding complicated legal procedures to that pain can feel unbearable. Our probate and succession team ensures that legacies are handled smoothly, fairly, and without unnecessary conflict. We guide families through the entire process — validating wills, administering estates, distributing assets, and resolving disputes among heirs. If there is no will, we provide clear pathways under succession law to ensure rightful heirs inherit what they deserve. We also manage complex cases involving high-value assets, businesses, or international properties with precision. Where disputes arise, we prioritize amicable settlement but are fully prepared for strong litigation if required. Beyond paperwork, we act as mediators and protectors of family bonds. With us, probate isn’t just about dividing assets — it’s about safeguarding the memory of loved ones while ensuring legal justice and smooth transitions for future generations."},
  4: {title: "Consumer Affairs", details: "In today’s marketplace, consumers face everything from defective products to fraudulent services and unethical corporate behavior. Our consumer affairs division champions your right to fairness. Whether you’ve been misled by false advertising, overcharged, delivered substandard goods, or exploited by corporations, we step in as your legal voice. We file consumer complaints, represent clients before consumer forums, and ensure companies are held accountable. Beyond compensation, our mission is to bring systemic accountability, pushing businesses toward ethical practices. We balance swift legal remedies with long-term protection strategies, ensuring you don’t just win a case but also prevent repeat exploitation. For us, every consumer case is not just about money — it’s about restoring dignity, trust, and fairness in the marketplace. With us, you’re never a powerless buyer; you’re a defended citizen whose rights matter."},
  5: {title: "Contract & Commercial Disputes", details: "Business thrives on trust, but disputes often arise when contracts are broken. We specialize in handling commercial disagreements ranging from partnership fallouts and service breaches to supply chain conflicts and corporate fraud. Our legal strategies aim to protect investments while minimizing business disruption. We draft, review, and enforce contracts with razor-sharp precision, ensuring your business interests remain secure. When disputes occur, we assess the fastest, most cost-effective path — whether through negotiation, arbitration, or litigation. We fight for compensation, compliance, and justice, all while keeping your brand reputation intact. For entrepreneurs, corporations, and startups alike, we provide not just defense, but foresight — preventing future disputes with airtight legal frameworks. In short, we keep your business running smoothly, even when the legal storms hit."},
  6: {title: "Employment & Labour Matters", details: "Workplaces should be spaces of growth, not conflict. Yet disputes over wages, wrongful termination, harassment, workplace safety, and unfair contracts are common. Our employment law practice represents both employers and employees with equal integrity. For employees, we fight for dignity, fairness, and rightful compensation. For employers, we provide legally sound policies, dispute management, and defense strategies that protect both compliance and corporate culture. We believe in balancing efficiency with fairness, ensuring harmony at the workplace. Whether it’s handling union negotiations, employee contracts, or harassment claims, our approach is strategic, compassionate, and legally airtight. We don’t just solve disputes — we prevent them, empowering workplaces to thrive under mutual respect and legal clarity."},
